...
if [ "$success" == "" ]
then
    python -c "from meteortools.utils import sendAnEmail ; sendAnEmail('markmcintyre99@googlemail.com','problem with matching','Error', mailfrom='ukmonhelper@ukmeteornetwork.co.uk')"
