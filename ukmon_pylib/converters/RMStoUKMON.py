...
def writeUkmonCsv(dir_path, file_name, data):
    ...
    with open(os.path.join(dir_path, file_name), 'w') as f:
        ...
        # Write the header
        f.write("Ver,Y,M,D,h,m,s,Mag,Dur,Az1,Alt1,Az2,Alt2,Ra1,Dec1,Ra2,Dec2,ID,Long,Lat,Alt,Tz,AngVel,Shwr,Filename\n")
        ...
        for line in data:
            ...
            f.write('{:s},{:4d},{:2d},{:2d},{:2d},{:2d},{:4.2f},{:.2f},{:.3f},{:.7f},{:.7f},{:.7f},{:.7f},{:.7f},{:.7f},{:.7f},{:.7f},{:s},{:.6f},{:.6f},{:.1f},{:.1f},{:7f},{:s},{:s}\n'.format(\
                ...
                elev, UT_corr, angvel, shwr, fname))
